  ...
  return (
    ...
    <div className={`sidebar max-sm:invisible max-h-[100vh] inline-flex px-4 py-4 flex-col justify-between bg-[#f0f4f9] font-custom transition-all duration-500 ${extend ? 'w-64' : 'w-20'}`}>
        ...
        <div className="bottom-item recent-entry flex items-start gap-3 p-3 pr-10 rounded-[50px] text-[#282828] cursor-pointer hover:bg-[#e2e6eb]">
          ...
          <p className={`transition-opacity duration-500 ${extend ? 'opacity-100' : 'opacity-0'}`}>Help</p>
        </div>
        <div className="bottom-item recent-entry flex items-start gap-3 p-3 pr-10 rounded-[50px] text-[#282828] cursor-pointer hover:bg-[#e2e6eb]">
          <img className='w-6' src={assets.history_icon} alt="" />
          <p className={`transition-opacity duration-500 ${extend ? 'opacity-100' : 'opacity-0'}`}>Activity</p>
        </div>
        <div className="bottom-item recent-entry flex items-start gap-3 p-3 pr-10 rounded-[50px] text-[#282828] cursor-pointer hover:bg-[#e2e6eb]">
          <img className='w-6' src={assets.setting_icon} alt="" />
          <p className={`transition-opacity duration-500 ${extend ? 'opacity-100' : 'opacity-0'}`}>Setting</p>
        </div>
      </div>
    </div>
  )
